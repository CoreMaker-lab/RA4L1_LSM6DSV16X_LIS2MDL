...
{ .timeout_mode = IIC_MASTER_TIMEOUT_MODE_SHORT,
  ...
  .smbus_operation = 0,
  /* Actual calculated bitrate: 391773. Actual calculated duty cycle: 49%. */.clock_settings.brl_value = 15,
  .clock_settings.brh_value = 14,
  .clock_settings.cks_value = 0,
  .clock_settings.sddl_value = 0,
  .clock_settings.dlcs_value = 0, };
const i2c_master_cfg_t g_i2c_master0_cfg =
{ .channel = 0, .rate = I2C_MASTER_RATE_FAST, .slave = 0x6A, .addr_mode = I2C_MASTER_ADDR_MODE_7BIT,
...
baud_setting_t g_uart9_baud_setting =
        {
        /* Baud rate calculated with 0.083% error. */.semr_baudrate_bits_b.abcse = 0,
          .semr_baudrate_bits_b.abcs = 0, .semr_baudrate_bits_b.bgdm = 1, .cks = 0, .brr = 14, .mddr = (uint8_t) 221, .semr_baudrate_bits_b.brme =
                  true };
